...
def record_audio_and_save(save_path, n_times=50):
    ...
    for i in range(n_times):
        ...
        sd.wait()
        write(save_path + str(i + index_rec * times_rec) + ".wav", fs, myrecording)
        input(f"Press to record next or two stop press ctrl + C ({i + index_rec * times_rec + 1}/{n_times}): ")
